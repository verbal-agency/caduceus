...
These items are intentionally outside the core roadmap. Promote one only after
the core system works and the user explicitly changes roadmap scope or order.
